...
var _ = framework.ReleasePipelinesSuiteDescribe("e2e tests for multi arch with rh-advisories pipeline", Label("release-pipelines", "rh-advisories", "multiarch-advisories"), Ordered, func() {
	defer GinkgoRecover()
