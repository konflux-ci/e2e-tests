...
var _ = framework.ReleasePipelinesSuiteDescribe("e2e tests for multi arch with rh-advisories pipeline", ginkgo.Label("release-pipelines", "rh-advisories", "multiarch-advisories"), func() {
