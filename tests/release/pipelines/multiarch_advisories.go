...
var _ = framework.ReleasePipelinesSuiteDescribe("e2e tests for multiarch-advisories pipeline", Label("release-pipelines", "multiarch-advisories"), func() {
	defer GinkgoRecover()
	...
	Describe("Multiarch-advisories happy path", Label("mulitiAdvisories"), func() {
		BeforeAll(func() {
