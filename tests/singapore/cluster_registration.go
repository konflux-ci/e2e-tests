...
var _ = framework.SingaporeSuiteDescribe("Cluster Registration tests", func() {
	...
	// possibile way, you create a pod that will: recieve KUBECONFIG via env variable; you set the kubeconfig; you run the command targeting the cluster; you reset the kubeconfig
