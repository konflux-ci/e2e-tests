...
horreum_schema_label_present '$.results.measurements.validateComponent.error_rate'
horreum_schema_label_present '$.results.measurements.validateComponent.pass.duration.mean'
