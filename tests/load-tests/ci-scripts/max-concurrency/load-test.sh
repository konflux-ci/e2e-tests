...
export QUAY_E2E_ORGANIZATION MY_GITHUB_ORG GITHUB_TOKEN THRESHOLD TEKTON_PERF_ENABLE_CPU_PROFILING TEKTON_PERF_ENABLE_MEMORY_PROFILING TEKTON_PERF_PROFILE_CPU_PERIOD
