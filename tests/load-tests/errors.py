...
FAILED_PLR_ERRORS = {
    ...
    ("Git failed to clone submodule because GitLab CEE giving 429", r"Error running git .*: exit status 128.*error: RPC failed; HTTP 429 curl 22 The requested URL returned error: 429.*fatal: clone of 'https://gitlab.cee.redhat.com/[^ ]+' into submodule path '[^ ]+' failed"),
    ("Git failed to fetch because GitLab CEE giving 429", r"Error running git .*: exit status 128.*remote: Retry later.*fatal: unable to access 'https://gitlab.cee.redhat.com/.*': The requested URL returned error: 429.*Error fetching git repository: failed to fetch [^ ]+: exit status 128"),
    ("Git failed to fetch because GitLab CEE giving 429", r"Error running git .*: exit status 128.*remote: Retry later.*fatal: unable to access 'https://gitlab.cee.redhat.com/.*': The requested URL returned error: 429.*Error fetching git repository: exit status 128"),
