...
All the instructions about installing RHTAP locally/CI and running tests locally/CI can be found in this [Documentation](docs/Installation.md). Contains also information about how to pair PR when breaking changes are introduced.
