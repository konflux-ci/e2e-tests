...
require (
	...
	github.com/hacbs-contract/enterprise-contract-controller/api v0.0.0-20221201093013-1985cbeddf7a
	...
	github.com/redhat-appstudio/release-service v0.0.0-20221108142952-258b71eb63ff
